...
<PageHeader heightClass="h-60 sm:h-80" color="bg-banking" largeHeader="{true}">
  <div
    class="flex items-center px-10 h-52 sm:h-96 bg-banking-light"
      ...
      <span class="inline-block tracking-wide font-heading">
        <section class="m-4 -mb-4 text-center">
          ...
          <h2 class="text-3xl sm:text-5xl">
            {balanceTime}<Icons icon="timeCircle" size="{10}" customClass="inline inline-icon" />
          </h2>
          <span class="text-2xl sm:text-3xl"> BALANCE </span>
        </section>
      </span>
    </div>
  </div>
