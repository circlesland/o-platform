...
<div class="bg-background">
  ...
  >
    <div class="mx-auto mb-2 lg:max-w-2xl sm:text-center">
      <p
        class="inline-block px-3 py-px mb-4 text-sm tracking-wider uppercase rounded-full text-primary bg-teal-accent-400"
      >
        Calculate paymentpath
      </p>
      <h2
        class="max-w-lg mx-auto mb-6 text-3xl text-center font-heading sm:text-4xl sm:leading-none"
      >
        Display payment path to
        <br />
        Full Node
      </h2>
      <div class="mt-8">
  ...
  <div class="w-full mx-auto text-center">
    <p
      class="inline-block px-3 py-px mb-4 text-xs uppercase rounded-full text-primary bg-teal-accent-400"
    >
      you can use up to
    </p>
    <h3
      class="max-w-lg mx-auto mb-6 text-3xl tracking-tight text-center font-heading sm:text-4xl sm:leading-none"
    >
