<div class="w-full bg-white">
  ...
  >
    <div class="grid gap-10 lg:grid-cols-2">
      <div class="flex items-center justify-center px-16 -mx-4 lg:p-0 lg:pl-8">
        <img src="/images/homepage/male.png" alt="person" />
      </div>
      <div class="flex flex-col justify-center md:pr-8 xl:pr-0 lg:max-w-lg">
        <div class="max-w-xl mb-6 font-circles text-secondary ">
          <h2
            class="max-w-lg mb-6 font-sans text-3xl font-bold tracking-tight font-circles text-secondary sm:text-4xl sm:leading-none"
          >
