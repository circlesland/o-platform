...
<div
  ...
  <div
    ...
    <button class="flex-grow" on:click="{() => playVideo()}">
      ...
      <div class="pt-0 text-lg text-center text-white sm:pt-2">
        {$_("dapps.o-homepage.components.videoHeader.playVideo")}
      </div>
    </button>
  </div>
</div>
<div id="container" class="z-50 w-full h-screen max-w-full min-w-full min-h-full">
  <vm-player class="h-screen">
    <vm-vimeo video-id="548283844" class="h-screen" cross-origin="true"></vm-vimeo>
    <!--  -->
