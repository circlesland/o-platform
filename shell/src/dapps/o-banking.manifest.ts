...
export const profile: Trigger<any, BankingDappState> = {
    type: "trigger",
    isSystem: true,
    routeParts: ["profile", ":id"],
    title: "Profile",
    eventFactory: (params) => runShellProcess(showProfile, {
        id: params.id,
    }),
    jumplist: profileJumplist
};

const transactionDetail: Trigger<{ _id: string }, BankingDappState> = {
    type: "trigger",
    isSystem: true,
    routeParts: ["transactions", ":_id"],
    title: "Transaction",
    eventFactory: (params) => runShellProcess(showTransaction, {
        id: params._id,
    }),
    jumplist: profileJumplist
};
