<script lang="ts">
    ...
    import {ProfileEvent, Purchased, SaleEvent} from "../../../shared/api/data/types";
        ...
        <div class="flex-col flex-grow">
            <div
                ...
                <span class="inline-block">
                  {dayjs(sale.invoice.createdAt).format("DD.MM.YYYY")}</span>
                </div>
                <!-- <div
            ...
            <div
                ...
                <div
                        ...
                        class:text-alert-dark="{!sale.invoice
