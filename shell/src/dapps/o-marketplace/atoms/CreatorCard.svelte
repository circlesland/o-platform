  ...
  <div
    ...
    <div class="relative flex-grow text-left truncate">
      <div class="max-w-full cursor-pointer truncateThis">
        <h2 class="text-2xl sm:text-3xl">{displayName}</h2>
      </div>
      ...
      <div class="mb-4 text-sm text-left text-alert">
        <svg
          ...
          <path
            ...
            5.636m12.728 12.728L5.636 5.636"></path>
        </svg>
        ...
        <button
          ...
          <svg
            ...
            <path
              ...
              stroke-linejoin="round"
              stroke-width="2"
              d="M17 9V7a2 2 0 00-2-2H5a2 2 0 00-2 2v6a2 2 0 002 2h2m2 4h10a2 2
              0 002-2v-6a2 2 0 00-2-2H9a2 2 0 00-2 2v6a2 2 0 002 2zm7-5a2 2 0
