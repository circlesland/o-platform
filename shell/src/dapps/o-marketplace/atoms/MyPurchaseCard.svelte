...
<div on:click="{() => loadDetailPage(purchased.purchase.id)}">
  <section
          on:click="{() => push(`#/marketplace/my-purchases/${purchased.purchase.id}`)}"
      ...
      <div class="flex-col flex-grow">
        <div
          ...
          <div
                ...
                <span class="inline-block">
                  {dayjs(purchased.purchase.createdAt).format("DD.MM.YY")}</span>
          </div>
        </div>
        <div
                class="flex flex-row items-center justify-between px-3 text-left">
        ...
        <div
          ...
          <div
                  ...
                  .paymentTransactionHash && !purchased.purchase.invoices[0].cancelledAt}"
