  ...
  <header class="grid overflow-hidden bg-white ">
    ...
    <div class="w-full text-center">
      {#if purchase}
        ...
        ><Label key="dapps.o-marketplace.pages.myPurchaseDetail.purchaseDate"></Label>
          ...
          <div class="pb-1 bg-gradient-to-r from-gradient1 to-gradient2">
            <h1
              ...
              {:else if invoice.simplePickupCode}
                <Label key="dapps.o-marketplace.pages.myPurchaseDetail.yourPickupNumber"></Label>
        ...
        <div class="flex flex-col w-full mb-6 space-y-2 text-left ">
          ...
          <div class="w-full text-center">
            {#if !invoice.pickupCode}
              <h1 class="text-3xl uppercase font-heading">
                <Label key="dapps.o-marketplace.pages.myPurchaseDetail.noCode"></Label>
              </h1>
            {:else}
