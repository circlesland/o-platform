<script lang="ts">
export let previousTarget: number = undefined;
export let progressTarget: number = undefined;
export let profilesCount: number = undefined;

let progressTargetCalc: number = progressTarget - previousTarget;

$: profilesCount -= previousTarget;
</script>
{#if previousTarget !== undefined && progressTarget !== undefined && profilesCount !== undefined}
