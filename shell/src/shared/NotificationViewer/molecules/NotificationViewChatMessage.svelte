...
<div class="flex flex-col space-y-4">
  <div class="self-center pb-2 text-2xl text-center font-heading"><Label key="shared.molecules.notificationViewer.molecules.notificationViewChatMessage.from"  /></div>
  <div class="pb-4">
