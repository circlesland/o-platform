...
{#if isOpen}
  ...
  >
    <div
      class="relative grid w-full max-h-full pt-2 mb-2 ml-2 mr-2 overflow-y-scroll bg-white rounded-lg top-2 min-w-min justify-items-stretch md:w-2/3 xl:w-1/2"
    >
