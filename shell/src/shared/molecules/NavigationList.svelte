...
<div class="z-10 flex flex-col flex-1">
  ...
  <div class="relative flex-shrink-0 p-4 pt-4 pb-20 space-y-2 w-52">
    <LinkPill
      props="{{ text: 'Legal Notice', link: '/#/homepage/tos', extern: true, isSmall: true }}" />
    <LinkPill
      props="{{ text: 'Terms & Privacy', link: '/#/homepage/tos', extern: true, isSmall: true }}" />
    <LinkPill
      props="{{ text: 'Help & Support', link: '/#/homepage/tos', extern: true, isSmall: true }}" />
    {#if navigation}
