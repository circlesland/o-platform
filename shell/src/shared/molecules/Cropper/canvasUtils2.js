export async function resizeImage(imagePath, downloadName, newWidth, newHeight) {
...
export function cropImage(imagePath, downloadName, newX, newY, newWidth, newHeight) {
  const originalImage = await createImage(imageSrc);
  originalImage.src = imagePath;
