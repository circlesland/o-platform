...
import {Profile, ProfileBySafeAddressDocument, ProfilesByNameDocument} from "./data/types";
                    ...
                    return result.data.search && result.data.search.length > 0
                        ? result.data.search
                            ...
                            .map((o) => {
                                return {
                                    ...o,
                                    circlesAddress: RpcGateway.get().utils.toChecksumAddress(o.circlesAddress),
