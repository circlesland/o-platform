...
export type ExchangeTokenMutation = { __typename?: "Mutation" } & {
  exchangeToken: { __typename?: "ExchangeTokenResponse" } & Pick<
...
export type AuthenticateAtMutation = { __typename?: "Mutation" } & {
  authenticateAt: { __typename?: "DelegateAuthInit" } & Pick<
    DelegateAuthInit,
    | "appId"
    | "success"
    | "errorMessage"
...
export type ClaimInvitationMutation = { __typename?: "Mutation" } & {
  claimInvitation: { __typename?: "ClaimInvitationResult" } & Pick<
    ClaimInvitationResult,
    "success"
  > & {
      claimedInvitation?: Maybe<
        { __typename?: "ClaimedInvitation" } & Pick<
          ClaimedInvitation,
          | "createdAt"
          | "createdByProfileId"
          | "claimedAt"
...
export type AcknowledgeMutation = { __typename?: "Mutation" } & Pick<
  Mutation,
  "acknowledge"
>;
        ...
        > & {
            safe_address_profile?: Maybe<
              { __typename?: "Profile" } & Pick<
                Profile,
                "id" | "firstName" | "lastName" | "avatarUrl" | "circlesAddress"
              >
            >;
            tags?: Maybe<
              Array<
                { __typename?: "Tag" } & Pick<Tag, "id" | "typeId" | "value">
              >
            >;
            payload?: Maybe<
              ...
              | ({ __typename?: "CrcHubTransfer" } & Pick<
                  CrcHubTransfer,
                  "from" | "to" | "flow"
                > & {
                    from_profile?: Maybe<
                    ...
                    >;
                    transfers: Array<
                      { __typename?: "CrcTokenTransfer" } & Pick<
                        CrcTokenTransfer,
                        "token" | "from" | "to" | "value"
                      > & {
                          from_profile?: Maybe<
              ...
              | { __typename?: "CrcSignup" }
              | { __typename?: "CrcTokenTransfer" }
              | ({ __typename?: "CrcTrust" } & Pick<
                  CrcTrust,
                  "address" | "can_send_to" | "limit"
                > & {
              ...
              | ({ __typename?: "GnosisSafeEthTransfer" } & Pick<
                  GnosisSafeEthTransfer,
                  "from" | "to" | "value"
                > & {
                    from_profile?: Maybe<
...
export type RedeemClaimedInvitationMutationVariables = Exact<{
  [key: string]: never;
}>;

export type RedeemClaimedInvitationMutation = { __typename?: "Mutation" } & {
  redeemClaimedInvitation: {
    __typename?: "RedeemClaimedInvitationResult";
  } & Pick<
    RedeemClaimedInvitationResult,
    "success" | "error" | "transactionHash"
  >;
};
...
export type CreateInvitationsMutation = { __typename?: "Mutation" } & {
  createInvitations: { __typename?: "CreateInvitationResult" } & Pick<
    CreateInvitationResult,
    "success" | "error"
  > & {
      createdInviteEoas: Array<
        { __typename?: "CreatedInvitation" } & Pick<
          CreatedInvitation,
          "name" | "address"
        >
      >;
...
export type ConsumeDepositedChallengeMutation = { __typename?: "Mutation" } & {
...
export type TagTransactionMutation = { __typename?: "Mutation" } & {
  tagTransaction: { __typename?: "TagTransactionResult" } & Pick<
...
export type UpsertProfileMutation = { __typename?: "Mutation" } & {
  upsertProfile: { __typename?: "Profile" } & Pick<
    Profile,
    | "id"
    | "firstName"
    | "lastName"
...
export type SessionInfoQuery = { __typename?: "Query" } & {
  sessionInfo: { __typename?: "SessionInfo" } & Pick<
    SessionInfo,
    "isLoggedOn" | "hasProfile" | "profileId"
  >;
};

export type WhoamiQueryVariables = Exact<{ [key: string]: never }>;

export type WhoamiQuery = { __typename?: "Query" } & Pick<Query, "whoami">;

export type ClaimedInvitationQueryVariables = Exact<{ [key: string]: never }>;

export type ClaimedInvitationQuery = { __typename?: "Query" } & {
  claimedInvitation?: Maybe<
    { __typename?: "ClaimedInvitation" } & Pick<
      ClaimedInvitation,
      "createdAt" | "createdByProfileId" | "claimedAt" | "claimedByProfileId"
    >
  >;
};

export type InvitationTransactionQueryVariables = Exact<{
  [key: string]: never;
}>;

export type InvitationTransactionQuery = { __typename?: "Query" } & {
  invitationTransaction?: Maybe<
    { __typename?: "ProfileEvent" } & Pick<ProfileEvent, "transaction_hash">
  >;
};

export type SafeFundingTransactionQueryVariables = Exact<{
  [key: string]: never;
}>;

export type SafeFundingTransactionQuery = { __typename?: "Query" } & {
...
export type MyInvitationsQuery = { __typename?: "Query" } & {
  myInvitations: Array<
    { __typename?: "CreatedInvitation" } & Pick<
      CreatedInvitation,
      "createdAt" | "claimedAt" | "name" | "address" | "balance" | "code"
    > & {
        claimedBy?: Maybe<
          { __typename?: "Profile" } & Pick<
            Profile,
...
export type CitiesByNameQuery = { __typename?: "Query" } & {
  cities: Array<
    { __typename?: "City" } & Pick<
      City,
      | "geonameid"
...
export type CitiesByIdQuery = { __typename?: "Query" } & {
  cities: Array<
    { __typename?: "City" } & Pick<
      City,
      | "geonameid"
...
export type ProfilesByNameQuery = { __typename?: "Query" } & {
  search: Array<
    { __typename?: "Profile" } & Pick<
      Profile,
      | "id"
    ...
    > & {
        city?: Maybe<
          { __typename?: "City" } & Pick<City, "geonameid" | "country" | "name">
        >;
      }
  >;
};
...
export type ProfilesByCirclesAddressQuery = { __typename?: "Query" } & {
...
export type ProfilesByIdsQuery = { __typename?: "Query" } & {
  profilesById: Array<
    { __typename?: "Profile" } & Pick<
      Profile,
      | "id"
...
export type TrustRelationsQuery = { __typename?: "Query" } & {
  trustRelations: Array<
    { __typename?: "TrustRelation" } & Pick<
      TrustRelation,
      "safeAddress" | "direction" | "otherSafeAddress"
    > & {
...
export type ChatHistoryQuery = { __typename?: "Query" } & {
  chatHistory: Array<
    ...
    > & {
        ...
        >;
        tags?: Maybe<
          Array<{ __typename?: "Tag" } & Pick<Tag, "id" | "typeId" | "value">>
        >;
        payload?: Maybe<
          | ({ __typename?: "ChatMessage" } & Pick<
              ChatMessage,
...
export type InboxQuery = { __typename?: "Query" } & {
  inbox: Array<
    { __typename?: "ProfileEvent" } & Pick<
      ProfileEvent,
      | "block_number"
          ...
          | ({ __typename?: "ChatMessage" } & Pick<
            ...
            > & {
                from_profile?: Maybe<
                  ...
                  > & {
                      city?: Maybe<
                        { __typename?: "City" } & Pick<City, "name" | "country">
                      >;
                    }
                >;
                to_profile?: Maybe<
...
export type ProfileByIdQuery = { __typename?: "Query" } & {
  profilesById: Array<
    { __typename?: "Profile" } & Pick<
      Profile,
      | "id"
...
export type ProfileBySafeAddressQuery = { __typename?: "Query" } & {
  profilesBySafeAddress: Array<
    { __typename?: "Profile" } & Pick<
      Profile,
      | "id"
...
export type TagsQuery = { __typename?: "Query" } & {
  tags: Array<{ __typename?: "Tag" } & Pick<Tag, "id" | "typeId" | "value">>;
};
...
export type TagByIdQuery = { __typename?: "Query" } & {
  tagById?: Maybe<
    { __typename?: "Tag" } & Pick<Tag, "id" | "typeId" | "value">
  >;
};
...
export type CommonTrustQuery = { __typename?: "Query" } & {
  commonTrust: Array<
    { __typename?: "CommonTrust" } & Pick<
      CommonTrust,
      "type" | "safeAddress1" | "safeAddress2"
    > & {
        profile?: Maybe<
          { __typename?: "Profile" } & Pick<
            Profile,
...
export const CitiesByNameDocument = gql`
  query citiesByName($name: String!, $languageCode: String) {
    cities(
      query: { byName: { name_like: $name, languageCode: $languageCode } }
    ) {
      geonameid
      name
      country
...
export function getSdk(
  ...
  return {
    exchangeToken(
      ...
      return withWrapper(() =>
        client.request<ExchangeTokenMutation>(
          print(ExchangeTokenDocument),
          variables
        )
      );
    },
    authenticateAt(
      variables: AuthenticateAtMutationVariables
    ): Promise<AuthenticateAtMutation> {
      return withWrapper(() =>
        client.request<AuthenticateAtMutation>(
          print(AuthenticateAtDocument),
          variables
        )
      );
    },
    claimInvitation(
      variables: ClaimInvitationMutationVariables
    ): Promise<ClaimInvitationMutation> {
      return withWrapper(() =>
        client.request<ClaimInvitationMutation>(
          print(ClaimInvitationDocument),
          variables
        )
      );
    },
    acknowledge(
      variables: AcknowledgeMutationVariables
    ): Promise<AcknowledgeMutation> {
      return withWrapper(() =>
        client.request<AcknowledgeMutation>(
          print(AcknowledgeDocument),
          variables
        )
      );
    },
    sendMessage(
      ...
      return withWrapper(() =>
        client.request<SendMessageMutation>(
          print(SendMessageDocument),
          variables
        )
      );
    },
    redeemClaimedInvitation(
      variables?: RedeemClaimedInvitationMutationVariables
    ): Promise<RedeemClaimedInvitationMutation> {
      return withWrapper(() =>
        client.request<RedeemClaimedInvitationMutation>(
          print(RedeemClaimedInvitationDocument),
          variables
        )
      );
    },
    createInvitations(
      variables: CreateInvitationsMutationVariables
    ): Promise<CreateInvitationsMutation> {
      return withWrapper(() =>
        client.request<CreateInvitationsMutation>(
          print(CreateInvitationsDocument),
          variables
        )
      );
    },
    consumeDepositedChallenge(
      variables: ConsumeDepositedChallengeMutationVariables
    ): Promise<ConsumeDepositedChallengeMutation> {
      return withWrapper(() =>
        client.request<ConsumeDepositedChallengeMutation>(
          print(ConsumeDepositedChallengeDocument),
          variables
        )
      );
    },
    logout(variables?: LogoutMutationVariables): Promise<LogoutMutation> {
      return withWrapper(() =>
        client.request<LogoutMutation>(print(LogoutDocument), variables)
      );
    },
    tagTransaction(
      variables: TagTransactionMutationVariables
    ): Promise<TagTransactionMutation> {
      return withWrapper(() =>
        client.request<TagTransactionMutation>(
          print(TagTransactionDocument),
          variables
        )
      );
    },
    upsertProfile(
      ...
      return withWrapper(() =>
        client.request<UpsertProfileMutation>(
          print(UpsertProfileDocument),
          variables
        )
      );
    },
    sessionInfo(
      variables?: SessionInfoQueryVariables
    ): Promise<SessionInfoQuery> {
      return withWrapper(() =>
        client.request<SessionInfoQuery>(print(SessionInfoDocument), variables)
      );
    },
    whoami(variables?: WhoamiQueryVariables): Promise<WhoamiQuery> {
      return withWrapper(() =>
        client.request<WhoamiQuery>(print(WhoamiDocument), variables)
      );
    },
    claimedInvitation(
      variables?: ClaimedInvitationQueryVariables
    ): Promise<ClaimedInvitationQuery> {
      return withWrapper(() =>
        client.request<ClaimedInvitationQuery>(
          print(ClaimedInvitationDocument),
          variables
        )
      );
    },
    invitationTransaction(
      variables?: InvitationTransactionQueryVariables
    ): Promise<InvitationTransactionQuery> {
      return withWrapper(() =>
        client.request<InvitationTransactionQuery>(
          print(InvitationTransactionDocument),
          variables
        )
      );
    },
    safeFundingTransaction(
      variables?: SafeFundingTransactionQueryVariables
    ): Promise<SafeFundingTransactionQuery> {
      return withWrapper(() =>
        client.request<SafeFundingTransactionQuery>(
          print(SafeFundingTransactionDocument),
          variables
        )
      );
    },
    myInvitations(
      variables?: MyInvitationsQueryVariables
    ): Promise<MyInvitationsQuery> {
      return withWrapper(() =>
        client.request<MyInvitationsQuery>(
          print(MyInvitationsDocument),
          variables
        )
      );
    },
    myProfile(variables?: MyProfileQueryVariables): Promise<MyProfileQuery> {
      return withWrapper(() =>
        client.request<MyProfileQuery>(print(MyProfileDocument), variables)
      );
    },
    profiles(variables: ProfilesQueryVariables): Promise<ProfilesQuery> {
      return withWrapper(() =>
        client.request<ProfilesQuery>(print(ProfilesDocument), variables)
      );
    },
    citiesByName(
      variables: CitiesByNameQueryVariables
    ): Promise<CitiesByNameQuery> {
      return withWrapper(() =>
        client.request<CitiesByNameQuery>(
          print(CitiesByNameDocument),
          variables
        )
      );
    },
    citiesById(variables: CitiesByIdQueryVariables): Promise<CitiesByIdQuery> {
      return withWrapper(() =>
        client.request<CitiesByIdQuery>(print(CitiesByIdDocument), variables)
      );
    },
    profilesByName(
      variables: ProfilesByNameQueryVariables
    ): Promise<ProfilesByNameQuery> {
      return withWrapper(() =>
        client.request<ProfilesByNameQuery>(
          print(ProfilesByNameDocument),
          variables
        )
      );
    },
    profilesByCirclesAddress(
      variables: ProfilesByCirclesAddressQueryVariables
    ): Promise<ProfilesByCirclesAddressQuery> {
      return withWrapper(() =>
        client.request<ProfilesByCirclesAddressQuery>(
          print(ProfilesByCirclesAddressDocument),
          variables
        )
      );
    },
    profilesByIds(
      variables: ProfilesByIdsQueryVariables
    ): Promise<ProfilesByIdsQuery> {
      return withWrapper(() =>
        client.request<ProfilesByIdsQuery>(
          print(ProfilesByIdsDocument),
          variables
        )
      );
    },
    trustRelations(
      variables: TrustRelationsQueryVariables
    ): Promise<TrustRelationsQuery> {
      return withWrapper(() =>
        client.request<TrustRelationsQuery>(
          print(TrustRelationsDocument),
          variables
        )
      );
    },
    contacts(variables: ContactsQueryVariables): Promise<ContactsQuery> {
      return withWrapper(() =>
        client.request<ContactsQuery>(print(ContactsDocument), variables)
      );
    },
    contact(variables: ContactQueryVariables): Promise<ContactQuery> {
      return withWrapper(() =>
        client.request<ContactQuery>(print(ContactDocument), variables)
      );
    },
    chatHistory(
      variables: ChatHistoryQueryVariables
    ): Promise<ChatHistoryQuery> {
      return withWrapper(() =>
        client.request<ChatHistoryQuery>(print(ChatHistoryDocument), variables)
      );
    },
    inbox(variables?: InboxQueryVariables): Promise<InboxQuery> {
      return withWrapper(() =>
        client.request<InboxQuery>(print(InboxDocument), variables)
      );
    },
    profileById(
      variables: ProfileByIdQueryVariables
    ): Promise<ProfileByIdQuery> {
      return withWrapper(() =>
        client.request<ProfileByIdQuery>(print(ProfileByIdDocument), variables)
      );
    },
    profileBySafeAddress(
      variables: ProfileBySafeAddressQueryVariables
    ): Promise<ProfileBySafeAddressQuery> {
      return withWrapper(() =>
        client.request<ProfileBySafeAddressQuery>(
          print(ProfileBySafeAddressDocument),
          variables
        )
      );
    },
    tags(variables: TagsQueryVariables): Promise<TagsQuery> {
      return withWrapper(() =>
        client.request<TagsQuery>(print(TagsDocument), variables)
      );
    },
    tagById(variables: TagByIdQueryVariables): Promise<TagByIdQuery> {
      return withWrapper(() =>
        client.request<TagByIdQuery>(print(TagByIdDocument), variables)
      );
    },
    stats(variables?: StatsQueryVariables): Promise<StatsQuery> {
      return withWrapper(() =>
        client.request<StatsQuery>(print(StatsDocument), variables)
      );
    },
    commonTrust(
      variables: CommonTrustQueryVariables
    ): Promise<CommonTrustQuery> {
      return withWrapper(() =>
        client.request<CommonTrustQuery>(print(CommonTrustDocument), variables)
      );
    },
  };
}
