...
export type GetStringsByMaxVersionQueryVariables = Exact<{
  lang?: Maybe<Scalars['String']>;
  key?: Maybe<Scalars['String']>;
}>;


export type GetStringsByMaxVersionQuery = (
  { __typename?: 'Query' }
  & { getStringsByMaxVersion?: Maybe<Array<(
    { __typename?: 'i18n' }
...
export const FindInvitationCreatorDocument = gql`
  ...
  findInvitationCreator(code: $code) {
    ...
    `;
export const GetStringsByMaxVersionDocument = gql`
    query GetStringsByMaxVersion($lang: String, $key: String) {
  getStringsByMaxVersion(lang: $lang, key: $key) {
    lang
    key
    createdBy
    version
...
export function getSdk(client: GraphQLClient, withWrapper: SdkFunctionWrapper = defaultWrapper) {
  return {
    ...
    GetStringsByMaxVersion(variables?: GetStringsByMaxVersionQueryVariables): Promise<GetStringsByMaxVersionQuery> {
      return withWrapper(() => client.request<GetStringsByMaxVersionQuery>(print(GetStringsByMaxVersionDocument), variables));
    },
